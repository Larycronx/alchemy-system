# Sistema de Alquimia para Foundry VTT v13

O **Sistema de Alquimia** é um módulo autônomo para **Foundry Virtual Tabletop v13** e **D&D 5e**. Ele implementa conhecimento individual, experimentação com dois ou três ingredientes, produção de poções e venenos, testes opcionais, histórico, anotações, favoritos, administração do Mestre e integração opcional com Midi-QOL.

> **Estado do projeto:** versão 1.0.0, núcleo funcional estável. O módulo não usa processo de compilação nem dependências JavaScript externas.
